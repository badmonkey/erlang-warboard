...
-include_lib("warboard/include/war_records.hrl").
...
-record(state,
    { pending_player_info       :: #{ war_type:player_id() => [type:server_from()] }
    , pending_player_stats      :: #{ war_type:player_id() => [type:server_from()] }
    }).
