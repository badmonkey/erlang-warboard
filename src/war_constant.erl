...
-spec world( binary() | string() | integer() ) -> war_type:world() | offline | type:exception().
...
world_json(connery) -> <<"1">>;
world_json(miller)  -> <<"10">>;
world_json(cobalt)  -> <<"13">>;
world_json(emerald) -> <<"17">>;
world_json(jaeger)  -> <<"19">>;
world_json(briggs)  -> <<"25">>.
